Public Class Formbillsalelist
    Private Tmaster As DataTable
    Private Sub Formbillsalelist_Load(sender As Object, e As EventArgs) Handles Me.Load
        Bindingmaster()
    End Sub
    Private Sub Formbillsalelist_Shown(sender As Object, e As EventArgs) Handles Me.Shown
    ...
    Private Sub Tbkeyword_TextChanged(sender As Object, e As EventArgs) Handles Tbkeyword.TextChanged
        ...
        If Tbkeyword.Text = "--version" Or Tbkeyword.Text = "-V" Then
            Informmessage("27/11/2018 17:00")
        End If
    End Sub
