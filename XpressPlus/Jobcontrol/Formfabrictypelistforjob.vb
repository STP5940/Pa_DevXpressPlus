Public Class Formfabrictypelistforjob
    Private Tmaster As DataTable
    Private Sub Bindingmaster()
        Tmaster = New DataTable
        Tmaster = SQLCommand("SELECT '' AS Stat,Comid,Clothid,Clothno,Ftype,Fwidth,Havedoz FROM Tclothxp
    ...
    Private Sub Tbkeyword_TextChanged(sender As Object, e As EventArgs) Handles Tbkeyword.TextChanged
        ...
        End If
    End Sub
    Private Sub Formfabrictypelistforjob_Load(sender As Object, e As EventArgs) Handles Me.Load
        Bindingmaster()
    End Sub
    ...
    End Sub
    Private Sub Formfabrictypelistforjob_Shown(sender As Object, e As EventArgs) Handles Me.Shown
