Public Class Formshipinglist
    Private Tmaster As DataTable
    Private Sub Formshipinglist_Load(sender As Object, e As EventArgs) Handles Me.Load
        Bindingmaster()
    End Sub
    Private Sub Formshipinglist_Shown(sender As Object, e As EventArgs) Handles Me.Shown
    ...
    Private Sub Bindingmaster()
        ...
        Tmaster = SQLCommand("SELECT '' AS Stat,Comid,Shipingid,Shippingname,Shipaddr1,Shipaddr2 FROM Tshippingxp
    ...
    Private Sub Filtermastergrid()
        ...
        If Tbkeyword.Text = "" Then
            ...
            Exit Sub
        End If
        Tmaster.DefaultView.RowFilter = String.Format("Shipingid Like '%{0}%' OR Shippingname LIKE '%{1}%'", Trim(Tbkeyword.Text), Trim(Tbkeyword.Text))
    End Sub
