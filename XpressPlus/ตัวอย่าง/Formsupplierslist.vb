Public Class Formsupplierslist
    ...
    Private Sub Formsupplierslist_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    End Sub
    Private Sub Formsupplierslist_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Bindingmaster()
    End Sub
    ...
    Private Sub Bindingmaster()
        ...
        Tmaster = SQLCommand("SELECT '' AS Stat,Comid,Supid,Supname FROM Tsuppliersxp
    ...
    Private Sub Filtermastergrid()
        ...
        If Tbkeyword.Text = "" Then
            ...
            Exit Sub
        End If
        Tmaster.DefaultView.RowFilter = String.Format("Supid Like '%{0}%' OR Supname LIKE '%{1}%'", Trim(Tbkeyword.Text), Trim(Tbkeyword.Text))
    End Sub
End Class