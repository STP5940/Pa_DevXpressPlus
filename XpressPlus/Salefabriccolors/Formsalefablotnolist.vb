Public Class Formsalefablotnolist
    Private Tmaster As DataTable
    Private Sub Formsalefablotnolist_Load(sender As Object, e As EventArgs) Handles Me.Load
        Bindingmaster()
    End Sub
    ...
    Private Sub Filtermastergrid()
        ...
        If Tbkeyword.Text = "" Then
            ...
            Exit Sub
        End If
        Tmaster.DefaultView.RowFilter = String.Format("Lotno Like '%{0}%'", Trim(Tbkeyword.Text))
    End Sub
