Public Class FormcustomerslistforSale
    ...
    Private Sub Tbkeyword_TextChanged(sender As Object, e As EventArgs) Handles Tbkeyword.TextChanged
        ...
        End If
    End Sub
    Private Sub FormcustomerslistforSale_Load(sender As Object, e As EventArgs) Handles Me.Load
        Bindingmaster()
    End Sub
    ...
    End Sub
    Private Sub FormcustomerslistforSale_Shown(sender As Object, e As EventArgs) Handles Me.Shown
