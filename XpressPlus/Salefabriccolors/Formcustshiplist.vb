Public Class Formcustshiplist
    Private Tmaster As DataTable
    Private Sub Bindingmaster()
        Tmaster = New DataTable
        Tmaster = SQLCommand("SELECT '' AS Stat,Comid,Custid,Addord,Custshipadd,Custshiptel,Custshipfax,Custshipcnt FROM Tcustshipxp
                                WHERE Comid = '" & Gscomid & "' AND Custid = '" & Trim(Tbcustid.Text) & "' AND Sstatus = 1 AND Sactive = '1'")
    ...
    Private Sub Filtermastergrid()
        ...
        If Tbkeyword.Text = "" Then
            ...
            Exit Sub
        End If
        Tmaster.DefaultView.RowFilter = String.Format("Custid Like '%{0}%' OR Custshipadd LIKE '%{1}%'", Trim(Tbkeyword.Text), Trim(Tbkeyword.Text))
    End Sub
    ...
    Private Sub Tbkeyword_TextChanged(sender As Object, e As EventArgs) Handles Tbkeyword.TextChanged
        ...
        End If
    End Sub
    Private Sub Formcustshiplist_Load(sender As Object, e As EventArgs) Handles Me.Load
        Bindingmaster()
    End Sub
    ...
    Private Sub Formcustshiplist_Shown(sender As Object, e As EventArgs) Handles Me.Shown
