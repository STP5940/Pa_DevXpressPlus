Public Class FormknittnolistOld
    ...
    Private Sub Filtermastergrid()
        ...
        If Tbkeyword.Text = "" Then
            ...
            Exit Sub
        End If
        Tmaster.DefaultView.RowFilter = String.Format("Dyedhid Like '%{0}%' OR Dyedhdesc LIKE '%{1}%'", Trim(Tbkeyword.Text), Trim(Tbkeyword.Text))
    End Sub
    ...
    Private Sub Tbkeyword_TextChanged(sender As Object, e As EventArgs) Handles Tbkeyword.TextChanged
        ...
        End If
    End Sub
    Private Sub Formdyedlist_Load(sender As Object, e As EventArgs) Handles Me.Load
        Bindingmaster()
    End Sub
    ...
    End Sub
    Private Sub Formdyedlist_Shown(sender As Object, e As EventArgs) Handles Me.Shown
